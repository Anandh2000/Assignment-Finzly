...
import com.finzly.loanApplicationManagement.entity.MenuDisplayer;
...
public class LoanApplicationController{
	...
	public ResponseEntity<?> bookTrade(@RequestBody @Valid User user){
		EntityModel<LoanApplicationController> enter = EntityModel.of(new LoanApplicationController());
	...
	public ResponseEntity<?> bookOrCancel(@RequestBody String bookorCancel){
		EntityModel<LoanApplicationController> entity = EntityModel.of(new LoanApplicationController());
