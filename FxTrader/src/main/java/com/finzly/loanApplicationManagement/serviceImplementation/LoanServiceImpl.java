...
import com.finzly.loanApplicationManagement.repository.TradingRepository;
...
import com.finzly.loanApplictionManagaement.Service.LoanService;
	...
	public ResponseEntity<?> saveTradeBeforeBooking(User user,EntityModel<LoanApplicationController> entity) {
		...
		if(user.getGetRateYesOrNo().equalsIgnoreCase("yes")) {
				...
				SuccessResponse successResponse = new SuccessResponse(
							"you are transferring "+trading.formatedAmount(ConvertedAmount)+" to "+user.getCustomerName(),entity , 200);
				...
				SuccessResponse successResponse = new SuccessResponse(
						"click the button to Book your trade:",entity , 200);
				return new ResponseEntity<>(successResponse, HttpStatus.OK);
			}
